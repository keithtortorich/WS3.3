...
-- Post-session execution trace graph for campaign, post, publish, and approval events.
--
-- Design source: RETAINED_GRAPH_MODEL.md (execution-trace nodes, not workflow-definition nodes).
--
-- Rules:
