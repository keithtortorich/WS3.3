...
|| **Business Manager** | **$2,497/mo, plus the contractor's own ad spend** | Everything in Office Staff + Sales Consultant + Marketing Coordinator + Growth Manager | Growth |

**Business Manager price correction (2026-07-24):** the $997/mo figure below this line in prior versions of this doc is superseded by `WEBSTAFFR_GOVERNANCE.md`, the current source of truth. The Marketing Coordinator role in this tier runs paid social and search advertising (Meta at minimum, plus any other platform the contractor already has a presence on) and optimizes toward actual ROI, not vanity metrics : real ongoing multi-platform ad-account management, not a lightweight bundled feature. Market research (2026) on equivalent standalone service (part-time in-house marketing hire, home-services agency retainer, or contractor marketing SaaS add-ons) clusters $2,000-$4,000/mo for that function alone, which supports pricing materially above the old $997 figure. The $2,497/mo price is WebStaffr's managed-service fee only; ad spend itself is a separate, additional cost the contractor pays directly to each ad platform and is never included in or marked up by WebStaffr's price. See `WEBSTAFFR_GOVERNANCE.md`'s Pricing Tiers section for the full per-role value breakdown.
